...
Insert into address(id, city, number, street) values (3,'Krasnywor', '21', 'Fajna');
...
Insert into pub (id, added, name, address_id, description) values (3, '2019-12-10', 'DDDDDDDDDD', 3, 'Opis pupu');
